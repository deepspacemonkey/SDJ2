public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(project1);// Danish:
        ...
        } catch (IllegalStateException e)// Using the same phrase as in Project
        {
        ...
        System.out.println(project2);// A new project with the project glossary as in project 1
